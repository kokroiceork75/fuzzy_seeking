...
#define load_data_path_target    "..\\..\\..\\1\\controllers\\seek_v1\\real_positions.txt"    
#define save_data_path01  "..\\..\\..\\1\\generated_file\\speed-w.txt"
#define save_data_path03  "rms.txt"  
#define save_data_path02  "..\\..\\..\\1\\generated_file\\error.txt" 
#define save_data_path_pos  "..\\..\\..\\1\\generated_file\\pos.txt" 
...
in_mu_2 =  1. ;
    for(i=1;i<= _in_varl-1;i++)
     ...
     i= _in_varl;
    {
           in_mu_2 =  in_mu_2 * phi(in[i] , fuzzy_real[(_rule-1)*_mem_length+i*2-1] , fuzzy_real[(_rule-1)*_mem_length+i*2] ) ;
      }  
